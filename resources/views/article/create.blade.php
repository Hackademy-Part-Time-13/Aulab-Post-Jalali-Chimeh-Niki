        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                ...
                <form class="card p-5 shadow" action="{{ route('article.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Titolo:
                        </label>
                        <input name="title" type="text" class="form-control" id="title" value="{{ old('title') }}">
                    </div>

                    <div class="mb-3">
                        <label for="subtitle" class="form-label">Sottotitolo:
                        </label>
                    ...
                    <div class="mb-3">
                        <label for="category" class="form-label">Categoria:
                        </label>
                    ...
                    <div class="mb-3">
                        <label for="body" class="form-label">Testo:
                        </label>
